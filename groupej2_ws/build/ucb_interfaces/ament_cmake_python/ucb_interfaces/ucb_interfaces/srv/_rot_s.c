...
bool ucb_interfaces__srv__rot__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // angle2
    ...
    assert(PyLong_Check(field));
    ros_message->angle2 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // angle3
    ...
    assert(PyLong_Check(field));
    ros_message->angle3 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // px
...
PyObject * ucb_interfaces__srv__rot__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // angle2
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->angle2);
    {
  ...
  {  // angle3
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->angle3);
    {
